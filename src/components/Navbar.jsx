...
export default function Navbar() {
  ...
  return (
    <div className="flex justify-between w-[80%] mx-auto items-center p-4">
      ...
      <h1 className="text-3xl text-[#00df9a] font-bold uppercase md:hidden z-50 p-4">
        React
      </h1>
      ...
      <ul
        className={
          nav
            ? " w-[50%] md:hidden fixed top-[10%] left-0 ease-in-out duration-1000 z-50 "
            : " w-full ease-in-out duration-1000 absolute top-[10%] left-[-100%] z-50 "
        }
      >
        <li className=" bg-black text-white p-8 border-b border-gray-600">Home</li>
      ...
      <div onClick={handleNav} className="text-[#00df9a] md:hidden z-50">
        {nav ? <FaTimes /> : <FaBars />}
      </div>
    </div>
  );
